  ...
  <app-upper-section [title]="'Disclaimer'"></app-upper-section>
      ...
      <div class=" shadow-lg rounded-lg p-8">
        ...
        <p class="text-light-600 mb-8">
          ...
          <a href="mailto:info@infoaidtech.net" class="text-blue-600 hover:text-blue-800 underline">info&#64;infoaidtech.net</a>.
        </p>

        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-light-900 mb-4">General Disclaimer for InfoaidTech</h2>
          <p class="text-light-600 mb-4">
            All the information on this website – <a href="https://infoaidtech.net" class="text-blue-600 hover:text-blue-800 underline">infoaidtech.net</a> – 
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-light-900 mb-4">External Links Disclaimer</h2>
          <p class="text-light-600 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-light-900 mb-4">Professional Advice Disclaimer</h2>
          <p class="text-light-600">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-light-900 mb-4">No Responsibility Disclaimer</h2>
          <p class="text-light-600">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-light-900 mb-4">"Use at Your Own Risk" Disclaimer</h2>
          <p class="text-light-600">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-light-900 mb-4">Updates</h2>
          <p class="text-light-600">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-light-900 mb-4">Contact Us</h2>
          <p class="text-light-600 mb-4">
            If you have any questions or concerns about this disclaimer, please contact us:
          </p>
          <div class="bg-light-100 p-4 rounded-lg">
            <p class="text-light-700"><strong>Company Name:</strong> InfoaidTech</p>
