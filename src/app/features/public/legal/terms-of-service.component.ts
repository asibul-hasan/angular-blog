  ...
  <section class="py-16 lg:py-20  min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl rounded-3xl p-8 md:p-12">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">1. Terms</h2>
          <p class="text-gray-300">
            By accessing this website, accessible from <a href="https://infoaidtech.net" class="text-[#f76179] hover:text-[#1e3e62] underline">infoaidtech.net</a>, 
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">3. Disclaimer</h2>
          <p class="text-gray-300">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">4. Limitations</h2>
          <p class="text-gray-300">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">5. Revisions and Errata</h2>
          <p class="text-gray-300">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">6. Links</h2>
          <p class="text-gray-300">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">7. Site Terms of Use Modifications</h2>
          <p class="text-gray-300">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">8. Governing Law</h2>
          <p class="text-gray-300">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">9. Contact Information</h2>
          <p class="text-gray-300">
            If you have any questions about these Terms and Conditions, please contact us:
          </p>
          <div class="mt-4 bg-white/5 p-4 rounded-lg border border-white/10">
