    ...
    <section class="py-16 lg:py-20  min-h-screen">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-gray-300 mb-6">
          At InfoaidTech, accessible at <a href="https://infoaidtech.net" class="text-[#f76179] hover:text-[#1e3e62] underline">infoaidtech.net</a>, 
        ...
        <p class="text-gray-300 mb-8">
          ...
          through email at <a href="mailto:info@infoaidtech.net" class="text-[#f76179] hover:text-[#1e3e62] underline">info&#64;infoaidtech.net</a>
        </p>
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">Log Files</h2>
          <p class="text-gray-300">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">Cookies and Web Beacons</h2>
          <p class="text-gray-300 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">DoubleClick DART Cookie</h2>
          <p class="text-gray-300 mb-4">
            ...
            <a href="https://policies.google.com/technologies/ads" class="text-[#f76179] hover:text-[#1e3e62] underline" target="_blank">https://policies.google.com/technologies/ads</a>.
          </p>
        </section>

        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">Advertising Partners Privacy Policies</h2>
          <p class="text-gray-300 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">Third-Party Privacy Policies</h2>
          <p class="text-gray-300 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">CCPA Privacy Policy (Do Not Sell My Personal Information)</h2>
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">GDPR Privacy Policy (Data Protection Rights)</h2>
          <p class="text-gray-300 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-white mb-4">Children's Information</h2>
          <p class="text-gray-300 mb-4">
